...
namespace Algorithm_Dictionary.자료구조_Form.기수정렬
{
    public partial class RadixSort : Form
    {
        ...
        private void RadixSort_Load(object sender, EventArgs e)
        {
            ...
            tb_sort.AppendText("먼저 버킷을 큐로 구성하여 사용하므로 큐에 대한 연산을 정의합니다.\r\n그리고 기수정렬 함수 안에서는 배열 list에 있는 n개의 원소에 대해서 기수 정렬을 수행하는 연산을 수행합니다.\r\n여기 안에서는 정렬할 자료의 기수, 즉 RADIX에 따라 10개의 버킷을 큐로 생성하고 키값의 자릿수만큼 반복 수행해 정렬을 해 나갑니다.\r\n이 과정을 코드로 자세히 보고 싶으시다면 코드보기 버튼을 눌러주세요.");
        }
    }
}
