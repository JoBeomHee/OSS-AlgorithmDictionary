...
namespace Algorithm_Dictionary.자료구조_Form.히프정렬
{
    public partial class HeapSort : Form
    {
        ...
        private void HeapSort_Load(object sender, EventArgs e)
        {
            ...
            tb_sort.AppendText("다음은 힙 정렬 함수의 설명입니다. 첫 번째로 n개의 노드에 대한 완전 이진 트리를 구성합니다. 그리고 나서 두 번째로 최대 힙을 구성합니다. 세 번째로는 가장 큰 수(루트에 위치)를 가장 작은 수와 교환을 합니다. 네 번째로는 두 번째와 세 번째를 반복합니다. 이것이 힙 정렬의 핵심입니다. 이 것을 C코드로 보고 싶으시다면 아래 코드보기 버튼을 클릭해 주세요.");
        }
